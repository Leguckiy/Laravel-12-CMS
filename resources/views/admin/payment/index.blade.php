...
@section('content')
    <div class="card">
        <div class="card-header">
            ...
            <span>{{ __('admin.payment_methods_list') }}</span>
        </div>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <x-admin.action-buttons-row
                                        :id="$method['code']"
                                        baseName="payment"
                                        :editRoute="route('admin.payment.edit', $method['code'])"
                                        showRoute=""
                                        destroyRoute=""
                                        showPermission=""
                                        destroyPermission=""
                                        :itemName="__('admin.payment_method')"
                                        :confirmText="__('admin.delete_confirm', ['item' => __('admin.payment_method')])"
                                    />
                                </td>
                            </tr>
                        @endforeach
