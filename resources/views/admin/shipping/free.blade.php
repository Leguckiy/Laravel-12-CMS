        ...
        <div class="card-body">
            <form action="{{ route('admin.shipping.update', $method['code']) }}" method="POST">
                ...
                <x-admin.input-field
                    type="number"
                    name="sub_total"
                    :label="__('admin.shipping_sub_total')"
                    :placeholder="__('admin.shipping_sub_total')"
                    :value="old('sub_total', data_get($shippingMethod->config, 'sub_total', ''))"
                    :required="true"
                    :hint="__('admin.shipping_sub_total_help')"
                />
                <x-admin.input-field
                    type="number"
                    name="sort_order"
